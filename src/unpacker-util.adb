package body Unpacker.Util is
	...
	function Get_Language_ID (File_Name : String) return String is
		type Language_Type is (En, Fr, De, It, Pn, Pt, Sp, Ru, Po, Cs, Ct, Mx, Ko); -- Pn here means Jpn
	begin
		case Language_Type'Value (File_Name (File_Name'Last - 7 .. File_Name'Last - 6)) is
	...
	exception
		when Constraint_Error => -- Invalid value, length, etc. - in any case should return ""
			return "";
	end Get_Language_ID;
