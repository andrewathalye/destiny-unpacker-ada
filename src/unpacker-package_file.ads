...
package Unpacker.Package_File is
	...
	type Entry_Reference_Type is (UNK, STRING_BNK, STRING_REF, STRING_REF_IDX, FONT_REF, LOAD_ZONE, MAIN_MODEL, SUBFILES, DYN_HEADER, ANIMATION, TERRAIN, MATERIAL, AUDIO_REF);
